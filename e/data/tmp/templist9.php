...
$bqno++;
?>
     <li><a href="[!--news.url--]<?=$bqr[classpath]?>"  class="<?php if($bqr[classid] ==66){echo 'on';} ?>"><?=$bqr[classname]?></a></li>
...
?>
                                   ...
                                   <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(66,1,0,0,'firsttitle=1','newstime DESC');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                     ...
                     <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(66,10,0,0,'firsttitle!=1','newstime DESC');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
